...
--INSERT INTO calisanlar VALUES('10010', 'Mehmet Yılmaz', 5000, '2018-04-14');--unique cons. oldugu icin kabul etmez
...
INSERT INTO calisanlar VALUES( null, 'filiz ' ,12000, '2018-04-14');--primary key null dan dolayi hata verdi
...
--ERROR VERDI CUNKU 10000DEN FAZLA OLSUN DEDIK
INSERT INTO calisanlar1 VALUES('10002', 'Mehmet Yılmaz' ,9000, '2018-04-14');
...
--DML --DELETE KOMUTU
DELETE FROM calisanlar;--eger parent tablo baska bir child tablo ile iliskili ise oce child tablo silinmelidir
DELETE FROM adresler;
SELECT * FROM adresler;

--ADRESLER TABLOSUNDA SEHRI ANTEP OLAN VERILERI SILINIZ
